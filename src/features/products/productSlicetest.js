...
const fetchProducts = createAsyncThunk("products/fetchProducts", () => {
  return axios
    .get("https://branquice.onrender.com/products")
...
const fetchProduct = createAsyncThunk(
  ...
  ({ filter, value, userId }) => {
    ...
    return axios
      .get(
        `https://branquice.onrender.com/products/?filter=${filter}&value=${value}&userId=${
          userId || null
        }`
      )
...
const editProduct = createAsyncThunk(
  ...
  ({ id, findBy, infoUpdated }) => {
    // console.log(value);
    return axios
      .put(`https://branquice.onrender.com/products/update`, {
        id,
        findBy,
        infoUpdated,
      })
...
const createProduct = createAsyncThunk(
  ...
  ({ products, userId }) => {
    // console.log(value);
    return axios
      .post(`https://branquice.onrender.com/products/upload`, {
        productos: [...products],
        userId: userId || null,
      })
      .then((response) => response.data);
...
const deleteProduct = createAsyncThunk("products/deleteProduct", (id) => {
  // console.log(value);
  return axios
    .post(`https://branquice.onrender.com/products/delete`, {
      id,
    })
    .then((response) => response.data);
});
const addProductStock = createAsyncThunk(
  ...
  ({ productBarcode, quantity, id }) => {
    ...
    return axios
      .put(`https://branquice.onrender.com/add/product/stock`, {
        productBarcode,
...
const fetchTotalInvest = createAsyncThunk(
  ...
  (investType) => {
    return axios
      .get(`https://branquice.onrender.com/product/invest/?investType=${investType}`)
      .then((response) => response.data);
  }
);
const decreaseStock = createAsyncThunk(
  ...
  ({ products }) => {
    return axios
      .post(`https://branquice.onrender.com/product/sell`, {
        productos: [
...
const makeTicket = createAsyncThunk(
  ...
  ({ products, total, user, client, description, createdAt, status }) => {
    ...
    return axios
      .post(`https://branquice.onrender.com/Tickets`, {
        products,
        total,
        user,
        client,
...
const getTickets = createAsyncThunk("products/getTickets", () => {
  return axios
    .get(`https://branquice.onrender.com/Tickets`)
    .then((response) => response.data);
});
const getTicket = createAsyncThunk("products/getTicket", (id) => {
  return axios
    .get(`https://branquice.onrender.com/Tickets/?id=${id}`)
    .then((response) => response.data);
});
const deleteTicket = createAsyncThunk("products/deleteTicket", (id, user) => {
  return axios
    .post(`https://branquice.onrender.com/Ticket/delete`, {
      id,
      user,
    })
    .then((response) => response.data);
...
const associateProduct = createAsyncThunk(
  ...
  ({ userId, productId }) => {
    return axios
      .post(`https://branquice.onrender.com/product/add/user`, {
        userId,
        productId,
      })
      .then((response) => response.data);
...
const getUserProducts = createAsyncThunk(
  ...
  ({ userId }) => {
    return axios
      .get(`https://branquice.onrender.com/product/get/user/?userId=${userId}`)
      .then((response) => response.data);
  }
);
const deleteUserProduct = createAsyncThunk(
  ...
  ({ userId, productId }) => {
    return axios
      .delete(
        `https://branquice.onrender.com/product/delete/user/?userId=${userId}&productId=${productId}`
      )
      .then((response) => response.data);
  }
);
const filterTickets = createAsyncThunk(
  ...
  ({ filter, value }) => {
    return axios
      .get(
        `https://branquice.onrender.com/Tickets/search/?filter=${filter}&value=${value}`
      )
      .then((response) => response.data);
  }
);
const editTicket = createAsyncThunk("Ticket/edit", (editingTicket) => {
  return axios
    .put(`https://branquice.onrender.com/Ticket/edit`, {
      editingTicket,
    })
    .then((response) => response.data);
});
