...
const createUser = createAsyncThunk(
  ...
  async ({ user }, { rejectWithValue }) => {
    try {
      const response = await axios.post("https://branquice.onrender.com/users", {
        user: user,
      });
...
const fetchUser = createAsyncThunk(
  ...
  async ({ filter, value, password }, { rejectWithValue }) => {
    try {
      const response = await axios.get("https://branquice.onrender.com/users", {
...
const editUser = createAsyncThunk(
  ...
  async ({ editingUser }, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.put("https://branquice.onrender.com/users", { editingUser }, {
        headers: {
