...
const createSucursal = createAsyncThunk('sucursales/createSucursal', ({sucursal, userId}) => {
    return axios.post('https://branquice.onrender.com/sucursales', {sucursal: sucursal, userId: userId})
...
const fetchSucursal = createAsyncThunk('sucursales/fetchSucursal', ({filter, value}) => {
    console.log(value);
    return axios.get(`https://branquice.onrender.com/sucursales/?filter=${filter}&value=${value}`)
    .then( response => response.data)
})

const associateProductToSucursal = createAsyncThunk('sucursales/associateProductToSucursal', ({sucursalId, productId}) => {
    return axios.post(`https://branquice.onrender.com/sucursales/add/product`, {
        sucursalId,
        productId
    })
    .then( response => response.data)
...
const getSucursalProducts = createAsyncThunk('sucursales/getSucursalProducts', ({sucursalId}) => {
    return axios.get(`https://branquice.onrender.com/sucursales/get/product/?sucursalId=${sucursalId}`)
    .then( response => response.data)
})
const deleteSucursalProduct = createAsyncThunk('sucursales/deleteSucursalProduct', ({sucursalId, productId}) => {
    return axios.delete(`https://branquice.onrender.com/sucursales/delete/product/?sucursalId=${sucursalId}&productId=${productId}`)
    .then( response => response.data)
})
