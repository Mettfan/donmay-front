...
const fetchAnalytics = createAsyncThunk('users/fetchAnalytics', ({analytic}) => {
    ...
    return axios.get(`https://branquice.onrender.com/analytic/${analytic}`)
    .then( response => response.data)
})
const fetchIncome = createAsyncThunk('users/fetchIncome', () => {
    return axios.get(`https://branquice.onrender.com/analytic/income`)
    .then( response => response.data)
})
const fetchOutcome = createAsyncThunk('users/fetchOutcome', () => {
    return axios.get(`https://branquice.onrender.com/analytic/outcome`)
    .then( response => response.data)
})
